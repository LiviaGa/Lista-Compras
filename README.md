...
```
- @Database(entities = [ItemModel::class], version = 1): Essa linha diz que este é o banco de dados. Ela especifica quais tipos de "coisas" (entities = [ItemModel::class]) serão guardadas nele e qual a "versão" do banco (a version = 1 indica que é a primeira versão dele).
